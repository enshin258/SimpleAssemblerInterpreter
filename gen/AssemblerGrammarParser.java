...
public class AssemblerGrammarParser extends Parser {
	...
	public static class PruleContext extends ParserRuleContext {
		public List<TerminalNode> CHAR() { return getTokens(AssemblerGrammarParser.CHAR); }
		public TerminalNode CHAR(int i) {
			return getToken(AssemblerGrammarParser.CHAR, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerGrammarListener ) ((AssemblerGrammarListener)listener).enterPrule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AssemblerGrammarListener ) ((AssemblerGrammarListener)listener).exitPrule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AssemblerGrammarVisitor ) return ((AssemblerGrammarVisitor<? extends T>)visitor).visitPrule(this);
